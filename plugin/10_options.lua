...
vim.o.laststatus     = 3          -- One global statusline instead of one per window
...
vim.o.scrolloff      = 999        -- Keep the cursor center in the screen
...
local diagnostic_opts = {
  ...
  -- Same filled-circle glyph for every severity, ported from the previous
  -- config - only the 'DiagnosticSign*' highlight color tells them apart.
  signs = {
    priority = 9999,
